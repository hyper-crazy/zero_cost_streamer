...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    _pageController = PageController(
      ...
      initialPage: _currentTrendingPage,
    );
                        ...
                        child: provider.sliderContent.isEmpty
                            ...
                            : PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final list = provider.sliderContent
                                      .take(7)
                                      .toList();
                                    ...
                                    child: Padding(
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Stack(
                                          ...
                                          children: [
                                            CachedNetworkImage(
                                              imageUrl: content.fullBackdropUrl,
                                              fit: BoxFit.cover,
                      ...
                      : SliverGrid(
                          ...
                          delegate: SliverChildBuilderDelegate(
                            (context, index) => ContentCard(
                              content: provider.gridContent[index],
                            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text(
                        "Please check your internet and press Try Again.",
...
class _StickyChipDelegate extends SliverPersistentHeaderDelegate {
  ...
  @override
  bool shouldRebuild(covariant _StickyChipDelegate old) => true;
}
