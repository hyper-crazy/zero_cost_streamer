...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> _loadTrailer() async {
    try {
      final key = await _api.getYoutubeKey(
        widget.movie.id,
                ...
                itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                  ...
                  if (isCompleted)
                    const PopupMenuItem<String>(
                      ...
                      child: Text('Remove from Completed'),
                    ),
                ],
              ),
            ],
                          ...
                          onPressed: () {
                            ...
                            if (Platform.isWindows) {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) =>
                                      PlayerScreen(content: widget.movie),
                                ),
                              );
                            } else {
                              if (widget.movie.mediaType == 'tv') {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (_) => SeasonSelectionScreen(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (!_isLoadingRecommendations)
                        IconButton(
                          icon: Icon(Icons.refresh, color: mainButtonColor),
                  ...
                  _isLoadingRecommendations
                      ...
                      : GridView.builder(
                          ...
                          itemBuilder: (context, index) =>
                              ContentCard(content: _recommendations[index]),
                        ),
                  const SizedBox(height: 40),
                ],
              ),
